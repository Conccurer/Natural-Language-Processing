...
# Term Frequency (fromula) = No. of repetation of words in sentence / No. of words in sentence
# Inverse Document Frequency = log( No. of sentence / No. of sentence containing the words)
# Final = Term_Frequency * Inverse_Document_Frequency
